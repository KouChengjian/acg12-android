...
public class AlbumActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.plugin_camera_album);  // Res.getLayoutID("plugin_camera_album")
	...
	private void init() {
		...
		back = (Button) findViewById(Res.getWidgetID("back")); //Res.getWidgetID("back")  R.id.back
