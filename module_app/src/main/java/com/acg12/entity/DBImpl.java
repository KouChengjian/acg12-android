...
public enum DBImpl implements SQLiteHelper.OnUpdateListener {
    ...
    DBImpl() {
        DataBaseConfig config = new DataBaseConfig(BaseApp.app());
    ...
    /**
     * <b>doStart must >=0 and smaller than end</b>
     * <p>delete from doStart to the end, <b>[doStart,end].</b>
     * <p>set end={@link Integer#MAX_VALUE} will delete all rows from the doStart
     *
     * @return the number of affected rows
     */
