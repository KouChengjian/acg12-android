 ...
 * Description:
 */
public class NewestAlbumViewHolder extends CommonRecyclerViewHolder {
    ...
    NewestAlbumAdapter.NewestAlbumListener newestAlbumListener;
    ...
    public NewestAlbumViewHolder(View itemView) {
        super(itemView);
    ...
    public void setNewestAlbumListener(NewestAlbumAdapter.NewestAlbumListener newestAlbumListener) {
...
//            LogUtil.e("url = " + url);
        ...
        btn_newest_album_collect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (newestAlbumListener != null) {
                    newestAlbumListener.onClickCollect(position);
                }
            }
        });
