...
public class Constant {
	...
	// URL-域名
	public static final String URL = debug ? "http://192.168.3.4:8080/":"http://120.25.97.142:8080/";
	// 主页-内容
	...
	// 发现 - 所有番剧
	public static final String URL_FIND_BANKUN = URL + "find/bunkung?&page=";//所有的动画资源

	// 搜索 - 图片
	public static final String URL_SEARCH_ALBUM   = URL + "search/album?key=";
	// 搜索 - 画集
	public static final String URL_SEARCH_PALETTE = URL + "search/palette?key=";
	// 搜索 - 视频
	public static final String URL_SEARCH_VIDEO   = URL + "search/video?key=";
	// 搜索 - 番剧
	public static final String URL_SEARCH_SERIES  = URL + "search/bangunmi?key=";
