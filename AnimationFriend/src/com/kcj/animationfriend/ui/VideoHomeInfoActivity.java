...
import com.kcj.animationfriend.adapter.HomeScrollTabPagerdAdapter;
 ...
 */
public class VideoHomeInfoActivity extends BaseActivity implements ScrollTabHolder , OnClickListener ,ParameCallBack{
	...
	protected HomeScrollTabPagerdAdapter adapter;
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(R.layout.activity_video_homeinfo);
	...
	public void initViews() {
		header = mInflater.inflate(R.layout.include_video_info_1, null);
		...
		tv_video_author = (TextView)header.findViewById(R.id.tv_video_author);
		...
		tv_video_time = (TextView)header.findViewById(R.id.tv_video_time);
		btn_video_play = (Button)header.findViewById(R.id.btn_video_play);
		ll_info_header.addView(header);
		
		adapter = new HomeScrollTabPagerdAdapter(getSupportFragmentManager(),video , this);
