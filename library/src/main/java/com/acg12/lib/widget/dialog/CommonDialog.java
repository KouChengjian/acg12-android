...
//    private ImageLoader imageLoader;
     ...
     * 设置点击事件
     */
    public CommonDialog setOnClickListener(int viewId, View.OnClickListener listener) {
        mDialogView.findViewById(viewId).setOnClickListener(listener);
        return this;
    }

    public CommonDialog setImage(int viewId, Object path) {
...
//        imageLoader.displayImage(imageView.getContext(), path, imageView);
     ...
     * 设置TextView 文本
     */
    public CommonDialog setText(int viewId, CharSequence text) {
     ...
     * 设置TextView 文本
     */
    public CommonDialog setTextSize(int viewId, @DimenRes int resId) {
    ...
    public CommonDialog setVisibility(int viewId, int visibility) {
    ...
    public CommonDialog dismissDialog() {
        super.dismiss();
        return this;
    }

    public CommonDialog canceledOnTouchOutside(boolean cancel) {
