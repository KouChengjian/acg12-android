...
import com.acg12.cc.listener.IRecycleUpdataListener;
import com.acg12.cc.listener.ItemClickSupport;
import com.acg12.cc.utils.PixelUtil;
...
public class CommonRecycleview extends FrameLayout implements View.OnClickListener {
    ...
    public void init() {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(R.color.cc_theme_body);
