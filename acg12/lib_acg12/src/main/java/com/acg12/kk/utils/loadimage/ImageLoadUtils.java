package com.acg12.kk.utils.loadimage;
...
//    private static ImagePipelineConfig sOkHttpImagePipelineConfig;
    ...
    public static void glideLoading(Context mContext, String url, ImageView imageview) {
        Glide.with(mContext).load(url)
                .placeholder(R.mipmap.kk_bg_loading_pic)
                .animate(R.anim.kk_glide_loading_image_alpha_in)
                .error(R.mipmap.kk_bg_loading_pic)
                .into(imageview);
    }
    ...
    public static void glideCircleLoading(String url, ImageView imageview) {
        Glide.with(mContext).load(url)
                .placeholder(R.mipmap.kk_bg_avatar_default)
                .animate(R.anim.kk_glide_loading_image_alpha_in)
                .error(R.mipmap.kk_bg_avatar_default)
