...
import org.acg12.net.UserRequest;
import org.acg12.net.UserRetrofitClient;
...
public class UserRequestImpl implements UserRequest {
    ...
    public UserRequestImpl(Context mContext) {
        this.mContext = mContext;
    }

    public static UserRequestImpl getInstance(Context mContext) {
        if(instance == null){
            instance = new UserRequestImpl(mContext);
        }
        return instance;
    }
