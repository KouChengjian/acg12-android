 ...
 * Description:
 */
public class CollectPaletteViewHolder extends CommonRecyclerViewHolder {
    ...
    CollectPaletteAdapter.SearchPaletteListener searchPaletteListener;

    public CollectPaletteViewHolder(View itemView) {
        super(itemView);
    ...
    public void setSearchPaletteListener(CollectPaletteAdapter.SearchPaletteListener searchPaletteListener) {
