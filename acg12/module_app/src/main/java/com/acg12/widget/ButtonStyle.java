 ...
 * User: mayn
 * Date: 2019/2/23 17:48
 * Description:
 */
public class ButtonStyle extends android.support.v7.widget.AppCompatButton {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            normalColor = typedArray.getColor(R.styleable.ButtonStyle_normal_color, 0xffAEDEF4);
            ...
            currCorner = typedArray.getDimension(R.styleable.ButtonStyle_corner, 0);
