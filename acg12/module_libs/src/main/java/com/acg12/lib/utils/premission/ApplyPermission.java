package com.acg12.lib.utils.premission;
...
public class ApplyPermission {
	...
	public static void showMissingPermissionDialog(final Activity activity){
        ...
        builder.setTitle(R.string.kk_permission_help);
        builder.setMessage(R.string.kk_permission_text);
        builder.setCancelable(false);
        // 拒绝, 退出应用
        builder.setNegativeButton(R.string.kk_permission_quit, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setPositiveButton(R.string.kk_permission_settings, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            	dlg.dismiss();
