...
public class DownloadActivity extends PresenterActivityImpl<DownloadView> implements View.OnClickListener ,ItemClickSupport.OnItemClickListener ,
    ...
    private void refresh(){
        List<DownLoad> downloadList = DaoBaseImpl.getInstance().queryDownloadList();
    ...
    public void delDialog(final int position){
        ...
        alertDialog.setContent1("删除", new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                DaoBaseImpl.getInstance().delDownLoad(download);
