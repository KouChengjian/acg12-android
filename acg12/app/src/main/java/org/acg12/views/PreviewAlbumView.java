...
import org.acg12.widget.FixMultiViewPager;
...
public class PreviewAlbumView extends ViewImpl {
    ...
    public void bindData(int position , int originLeft ,int originTop  ,int originHeight ,int originWidth ,List<Album> albumList){
...
//            });
        ...
        preAlbumViewpage.setAdapter(new DragPagerAdapter(viewList));
        preAlbumViewpage.setCurrentItem(position);

//        preAlbumViewpage.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
//            @Override
//            public void onGlobalLayout() {
//                preAlbumViewpage.getViewTreeObserver().removeOnGlobalLayoutListener(this);
//
...
//
//                final View photoView = viewList.get(0);
