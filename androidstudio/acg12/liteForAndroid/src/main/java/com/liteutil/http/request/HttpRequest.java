...
import com.liteutil.http.request.body.ProgressBody;
import com.liteutil.http.request.body.RequestBody;
import com.liteutil.http.request.cookie.DbCookieStore;
...
public class HttpRequest extends UriRequest {
    ...
    public void sendRequest() throws IOException {
        ...
        { 
            ...
            connection.setReadTimeout(params.getConnectTimeout()); // 读取超时
            connection.setConnectTimeout(params.getConnectTimeout()); // 连接超时
            connection.setInstanceFollowRedirects(params.getRedirectHandler() == null); // 是否连接遵循重定向
        ...
        { 
            ...
            if (HttpMethod.permitsRequestBody(method)) {
                ...
                if (body != null) {
                    ...
                    body.writeTo(connection.getOutputStream()); // 读取流
                }
            }
        }
