package com.android.material.ui.fragment;
...
public class DialogFragment extends android.support.v4.app.DialogFragment{
    ...
    public interface Builder{
         ...
         */
        public com.android.material.view.Dialog build(Context context);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
    	com.android.material.view.Dialog dialog = mBuilder == null ? new Dialog(getActivity()) : mBuilder.build(getActivity());
